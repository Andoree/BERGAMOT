...
from graphmel.models.graphsage_dgi_sapbert import GraphSAGEDGISapMetricLearning
from graphmel.data.dataset import PositivePairNeighborSampler
...
from graphmel.utils.io import save_dict
...
def main(args):
    ...
    start = time.time()
    train_graph_sapbert_model(model=model, tokenizer=bert_tokenizer, train_epoch_fn=train_graphsage_sapbert,
